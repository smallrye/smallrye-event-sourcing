image:https://semaphoreci.com/api/v1/smallrye/smallrye-event-sourcing/branches/master/badge.svg["Semaphore CI", link="https://semaphoreci.com/smallrye/smallrye-event-sourcing"]

...
but the proposal document will only come into
...
'MicroProfile Event Sourcing' has been chosen. We do not believe there will
be another MicroProfile Specification that would be better placed to 'own' the name. 
